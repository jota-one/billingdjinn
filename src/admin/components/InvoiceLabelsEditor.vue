<template>
  <div class="flex flex-col gap-5">
    ...
    <!-- Métadonnées -->
    <div>
      <p class="text-xs font-semibold text-base-content/50 uppercase tracking-wide mb-3">Métadonnées</p>
      <div class="grid grid-cols-2 gap-3">
    ...
    <!-- Paiement -->
    <div>
      <p class="text-xs font-semibold text-base-content/50 uppercase tracking-wide mb-3">Paiement</p>
      <div class="flex flex-col gap-3">
        <div class="form-control">
          <label class="label"><span class="label-text text-xs">{{ KEY_LABELS.iban }}</span></label>
          <InputText
